...
export default {
  ...
  fonts: {
    body: "'neue-montreal-regular', sans-serif",
    bodyBold: "'neue-montreal-bold', sans-serif",
    bodyLight: "'neue-montreal-light', sans-serif",
    heading: "'woodland-regular', serif",
    headingBold: "'woodland-bold', serif",
    headingHeavy: "'woodland-heavy', serif",
    headingLight: "'woodland-ultralight', serif",
    accent: "Crimson Text",
  },
  fontSizes: {
    xs: "0.75rem",
